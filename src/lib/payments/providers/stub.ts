...
export const freeMoneyProvider = createStubProvider("free_money", "FREE_MONEY_API_KEY");
export const tmoneyProvider = createStubProvider("tmoney", "TMONEY_API_KEY");
export const floozProvider = createStubProvider("flooz", "FLOOZ_API_KEY");
export const bankTransferProvider = createStubProvider("bank_transfer", "BANK_TRANSFER_API_KEY");
export const cardProvider = createStubProvider("card", "CARD_GATEWAY_API_KEY");
export const qrProvider = createStubProvider("qr", "QR_GATEWAY_API_KEY");
